...
/**
 * This function actually look really similar to mpest's SNAFile generator
 * @author gatec
 *
 */
public class CreateSNAFileComplex {

	public static String type() {
		return "STAR";
	}
	public static String description() {
		return "If the user did not provide a SNA file, the program will generate one by using the speciesname.txt file.";
	}
	public static String parameter_info() {
		return "[fileName] [specialChar] [index numeric] [outputFile]";
	}
